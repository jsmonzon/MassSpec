"""
Run the Tree_Reader_Light measurement over the symmetric-LMC ("sym_LMC")
...
Usage (on the cluster):
    python run_abundance_light_LMC.py
    python run_abundance_light_LMC.py --ncores 32
    python run_abundance_light_LMC.py --mass-cut 6.75e9
    python run_abundance_light_LMC.py --input-dir /netb/vdbosch/jsm99/data/sym_LMC/DF_2/ \\
        --save-path /home/jsm99/data/sym_LMC/DF_2_light.h5
    python run_abundance_light_LMC.py --target-mass 12.05     # one bin only
"""
...
DEFAULT_INPUT_DIR = "/netb/vdbosch/jsm99/data/sym_LMC/DF_1/"
DEFAULT_SAVE_PATH = "/home/jsm99/data/sym_LMC/DF_1_light.h5"
DEFAULT_PARENTDIR = "/home/jsm99/SatGen/mcmc/src/"
DEFAULT_MASS_CUT = 1e8      # resolution-limit cut; NOTE: check appropriate for sym_LMC host masses
DEFAULT_TARGET_MASS = None  # take every mass bin in the directory
DEFAULT_NCORES = 16
...
def run_abundance_light_LMC(input_dir=DEFAULT_INPUT_DIR, save_path=DEFAULT_SAVE_PATH, label="sym_LMC_light",
...
def _parse_args():
    ...
    p.add_argument("--label", default="sym_LMC_light", help="prefix for progress lines")
...
if __name__ == "__main__":
    args = _parse_args()
    run_abundance_light_LMC(input_dir=args.input_dir, save_path=args.save_path, label=args.label,
